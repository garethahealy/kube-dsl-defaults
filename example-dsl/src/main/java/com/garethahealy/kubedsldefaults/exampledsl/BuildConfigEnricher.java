/*-
 * #%L
 * GarethHealy :: Kube DSL Defaults :: Example DSL
 * %%
 ...
 * #L%
 */
package com.garethahealy.kubedsldefaults.exampledsl;
    ...
    private BuildConfig addBuildConfig() {
        ...
        return new BuildConfigBuilder()
            .withNewSpec()
                ...
                .withNewSource()
                    .withNewGit()
                    .withUri("https://github.com/garethahealy/kube-dsl-defaults.git")
                    .endGit()
                    .withType("Git")
                .endSource()
                .withNewStrategy()
